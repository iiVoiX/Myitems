...
import com.praya.myitems.manager.plugin.*;
...
public class CommandMyItems extends HandlerCommand implements CommandExecutor {
    ...
    public static final List<String> list(final CommandSender sender, final Command command, final String label, final String[] args) {
        ...
        final List<String> keyList = (List<String>) SortUtil.toList(itemManager.getItemIDs());
    ...
    public boolean onCommand(final CommandSender sender, final Command command, final String label, final String[] args) {
        ...
        if (commandManager.checkCommand(subCommand, "MyItems_Reload")) {
            ...
            final String aboutBlank = new StringBuilder(prefix).toString();
            ...
            aboutFooter = TextUtil.placeholder(map, aboutFooter);
            ...
            aboutAuthor = TextUtil.placeholder(map, aboutAuthor);
            ...
            if (pluginPropertiesManager.getCompany() != null) {
                final HashMap<String, String> subMap = new HashMap<String, String>();
                String aboutCompany = prefix + "Company&7: &c{company}";
                subMap.put("company", pluginPropertiesManager.getCompany());
                aboutCompany = TextUtil.placeholder(subMap, aboutCompany);
            }
            if (!pluginPropertiesManager.getDevelopers().isEmpty()) {
                ...
                for (final String developer : pluginPropertiesManager.getDevelopers()) {
                    ...
                    aboutListDeveloper = TextUtil.placeholder(subMap2, aboutListDeveloper);
            ...
            if (SenderUtil.isPlayer(sender)) {
                ...
                message7.sendMessage(sender, mapPlaceholder);
                SenderUtil.playSound(sender, SoundEnum.ENTITY_EXPERIENCE_ORB_PICKUP);
            }
            ...
            if (target.equals(sender)) {
                ...
                message8.sendMessage(sender, mapPlaceholder2);
                SenderUtil.playSound(sender, SoundEnum.ENTITY_EXPERIENCE_ORB_PICKUP);
            } else {
                final MessageBuild messageToSender = lang.getMessage(sender, "MyItems_Load_Success_To_Sender");
                final MessageBuild messageToTarget = lang.getMessage(target, "MyItems_Load_Success_To_Target");
                final HashMap<String, String> mapPlaceholder2 = new HashMap<String, String>();
                mapPlaceholder2.put("nameID", name);
                mapPlaceholder2.put("amount", String.valueOf(amount2));
                ...
                messageToSender.sendMessage(sender, mapPlaceholder2);
                messageToTarget.sendMessage(target, mapPlaceholder2);
                SenderUtil.playSound(sender, SoundEnum.ENTITY_EXPERIENCE_ORB_PICKUP);
            ...
            final MessageBuild targetMessage = lang.getMessage(target2, "MyItems_Repair_Success_To_Target");
            ...
            statsManager.itemRepair(item, repair);
            senderMessage.sendMessage(sender, mapPlaceholder3);
            targetMessage.sendMessage(target2, mapPlaceholder3);
            SenderUtil.playSound(sender, SoundEnum.ENTITY_EXPERIENCE_ORB_PICKUP);
            ...
            final List<String> lores = EquipmentUtil.getLores(item3);
            ...
            detailHeader = TextUtil.placeholder(mapPlaceholder4, detailHeader);
            detailName = TextUtil.placeholder(mapPlaceholder4, detailName);
            detailDurability = TextUtil.placeholder(mapPlaceholder4, detailDurability);
            detailData = TextUtil.placeholder(mapPlaceholder4, detailData);
            detailHashCode = TextUtil.placeholder(mapPlaceholder4, detailHashCode);
            ...
            if (!lores.isEmpty()) {
                ...
                for (int i = 0; i < lores.size(); ++i) {
                    ...
                    loreMessage.sendMessage(sender, mapPlaceholder4);
                }
            }
            if (meta.hasEnchants()) {
                final String detailEnchantmentHead = lang.getText(sender, "Detail_Enchantment_Head");
                final Map<Enchantment, Integer> mapEnchantment = meta.getEnchants();
                SenderUtil.sendMessage(sender, " ");
                ...
                for (final Enchantment enchant : meta.getEnchants().keySet()) {
                    ...
                    enchantmentMessage.sendMessage(sender, mapPlaceholder4);
                }
            }
            if (!meta.getItemFlags().isEmpty()) {
                ...
                for (final ItemFlag flag : meta.getItemFlags()) {
                    ...
                    flagMessage.sendMessage(sender, mapPlaceholder4);
                }
            }
            SenderUtil.playSound(player6, SoundEnum.ENTITY_EXPERIENCE_ORB_PICKUP);
            return true;
