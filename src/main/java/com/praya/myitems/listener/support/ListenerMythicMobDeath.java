...
public class ListenerMythicMobDeath extends HandlerEvent implements Listener {
    ...
    public void eventMythicMobDeath(final MythicMobDeathEvent event) {
        ...
        final List<String> drops = Collections.singletonList(event.getDrops().toString());
        for (final String lineDrops : drops) {
            final String[] args = lineDrops.split(" ");
            if (args.length > 0) {
                final String key = args[0];
                if (args.length == 1) {
                    final Optional<DropTable> mythicDropTable = MythicBukkit.inst().getDropManager().getDropTable(key);
                    ...
                    if (item != null) {
                        ...
                        if (args.length > 3) {
                            ...
                            if (textAmount.contains("~")) {
                                ...
                                amount3 = (int) MathUtil.valueBetween(amount1, amount2);
                            } else {
                    ...
                    if (itemGenerator != null) {
                        ...
                        if (args.length > 3) {
                            ...
                            if (textLoop.contains("~")) {
                                ...
                                loop3 = (int) MathUtil.valueBetween(loop1, loop2);
                            } else {
                        ...
                        if (args.length > 4) {
                            ...
                            if (textAmount4.contains("~")) {
                                ...
                                amount6 = (int) MathUtil.valueBetween(amount4, amount5);
                            } else {
                ...
                if (socketTree != null) {
                    ...
                    if (args.length > 4) {
                        ...
                        if (textAmount7.contains("~")) {
                            ...
                            amount9 = (int) MathUtil.valueBetween(amount7, amount8);
                        } else {
