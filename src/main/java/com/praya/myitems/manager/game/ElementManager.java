...
public class ElementManager extends HandlerManager {
    ...
    private final String getKeyValue(final double value) {
        final MainConfig mainConfig = MainConfig.getInstance();
        return MainConfig.KEY_ELEMENT_VALUE + ((value > 0.0) ? mainConfig.getStatsLorePositiveValue() : mainConfig.getStatsLoreNegativeValue()) + value + MainConfig.KEY_ELEMENT_VALUE + mainConfig.getElementColor();
    }
}
