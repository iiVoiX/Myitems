...
public class AbilityWeaponManager extends HandlerManager {
    ...
    private final String getKeyAbility(final String ability, final Integer grade) {
        ...
        if (grade != null) {
            ...
            final String keyAbility2 = abilityKey + abilityColor + keyLore + " " + RomanNumber.getRomanNumber(abilityGrade) + abilityKey + abilityColor;
            return keyAbility2;
        }
        final String keyAbility3 = abilityKey + abilityColor + keyLore;
        return keyAbility3;
    }
    ...
    private final String getKeyChance(final Double chance) {
        ...
        if (chance != null) {
            final double abilityChance = MathUtil.limitDouble(chance, 0.0, 100.0);
            final String keyChance = abilityKeyPercent + abilityColorPercent + abilityChance + abilityKeyPercent + abilityColorPercent + "%";
            return keyChance;
        }
        final String keyChance2 = abilityKeyPercent + abilityColorPercent;
        return keyChance2;
    }
}
